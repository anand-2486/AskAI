  ...
  return (
    <div className='h-screen flex bg-[#0d0f14] text-white overflow-hidden'>
      {!userData && <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm'>
        ...
        <button className="w-full flex items-center justify-center gap-3 py-[11px] rounded-xl text-sm font-medium text-black bg-white hover:bg-gray-100 active:bg-gray-200 border border-gray-300 shadow-lg hover:shadow-xl transition-all duration-150 cursor-pointer" onClick={googleLogin}>
            <FcGoogle size={15} />
